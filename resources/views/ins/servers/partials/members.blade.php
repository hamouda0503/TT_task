<div class="row " style="background-color:#fafafa ">
    <div class="col-xs-12 col-md-6">
        ...
        <footer>
            <a v-on:click="inviteUser(server.id)" class="btn btn-primary pull-right" style="color:#FFF;">Send Invite</a>
        ...
        <table class="table table-striped">
            ...
            <tr v-for="member in members ">
                ...
                <td style="font-size: 1.5em">
                    <a title="Delete" v-on:click="removeMember(server.id, member)"><i class="ion-ios-close-outline"></i></a>
                </td>
            </tr>
            </tbody>
        </table>
