    ...
    <div id="user">
        <div class="row">
            <div class="col-xs-12 page-title-section">
                ...
                <a v-on:click="update()" class="btn btn-primary pull-right" title="Create new Platform" style="color:#fff ;" >Save Changes</a>
        ...
        <div class="row settings-container">
            <div class="col-xs-12">
                ...
                <div class="col-xs-14 col-md-13  right-side">
                    <div class="mega-menu">
                        ...
                        <div class="links">
                        <a class="" data-id="settings_info" href=""><i class="far fa-user"></i>  Personal Info</a>
                            <!-- <a class="" data-id="settings_links" href="">Links</a> -->
                            <a class="" data-id="settings" href=""><i class="fas fa-sliders-h"></i>  Account Settings</a>
                        </div>
                        <div class="content">
                                ...
                                <div class="form">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <span class="count pull-right">@{{ 250 - user.bio.length }} letter left</span>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="item" id="settings">
                                ...
                                <div class="form-group">
                                    {!! Form::submit( 'Update Password', array('class' => 'btn btn-default pull-right','style'=>'background-color: #26b2ad ;color:#fff')) !!}
                                    <div class="clearfix"></div>
                                </div>
                                {!! Form::close() !!}
                                <hr>
                                ...
                                <p class="dim">Deleting your account will delete <b>ALL</b>, Platforms, Servers and tasks created under this account</p>
                                <input v-model="delete_text" type="text" class="form-control" placeholder="Enable the delete button by typing delete below">
                                <br>
